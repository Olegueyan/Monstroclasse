...
public class WordCardSingleActionNode extends Pane
{
    ...
    public WordCardSingleActionNode(double width, double height, ButtonImage actionBtn, EcriluWordJson word)
    {
        ...
        this.ecriluWordJson = word;

        this.actionBtn = actionBtn;
    }

    public WordCardSingleActionNode(double width, double height, ButtonImage actionBtn, ButtonImage upBtn, ButtonImage downBtn, EcriluWordJson word)
    {
        this.setPrefWidth(width);
        this.setPrefHeight(height);
